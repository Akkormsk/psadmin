...
urlpatterns = [
    ...
    path("catalog/oasis/import-test/", views.oasis_import_test, name="oasis_import_test"),
    ...
    path("order/<int:pk>/save/", views.save_estimate, name="tender_estimate_save"),
    path("order/<int:pk>/duplicate/", views.duplicate_estimate, name="tender_estimate_duplicate"),
